...
package lumi.sparkynox.sparkymusic.widget
...
import lumi.sparkynox.sparkymusic.recognition.MusicRecognitionService
import lumi.sparkynox.sparkymusic.widget.MusicRecognizerWidgetService.Companion.ALBUM_ART_CACHE_FILE
import lumi.sparkynox.sparkymusic.widget.MusicRecognizerWidgetService.Companion.PREF_ARTIST_NAME
import lumi.sparkynox.sparkymusic.widget.MusicRecognizerWidgetService.Companion.PREF_COVER_ART_PATH
import lumi.sparkynox.sparkymusic.widget.MusicRecognizerWidgetService.Companion.PREF_ERROR_MESSAGE
import lumi.sparkynox.sparkymusic.widget.MusicRecognizerWidgetService.Companion.PREF_PULSE_FRAME
import lumi.sparkynox.sparkymusic.widget.MusicRecognizerWidgetService.Companion.PREF_SONG_TITLE
import lumi.sparkynox.sparkymusic.widget.MusicRecognizerWidgetService.Companion.PREF_STATE
import lumi.sparkynox.sparkymusic.widget.MusicRecognizerWidgetService.Companion.PREFS_NAME
import lumi.sparkynox.sparkymusic.widget.MusicRecognizerWidgetService.Companion.STATE_ERROR
import lumi.sparkynox.sparkymusic.widget.MusicRecognizerWidgetService.Companion.STATE_IDLE
import lumi.sparkynox.sparkymusic.widget.MusicRecognizerWidgetService.Companion.STATE_LISTENING
import lumi.sparkynox.sparkymusic.widget.MusicRecognizerWidgetService.Companion.STATE_NO_MATCH
import lumi.sparkynox.sparkymusic.widget.MusicRecognizerWidgetService.Companion.STATE_PROCESSING
import lumi.sparkynox.sparkymusic.widget.MusicRecognizerWidgetService.Companion.STATE_SUCCESS
import java.io.File
...
class MusicRecognizerWidgetReceiver : AppWidgetProvider() {
        ...
        if (!MusicRecognitionService.hasRecordPermission(context)) {
            context.startActivity(
                Intent(context, MainActivity::class.java).apply {
                    action = "lumi.sparkynox.sparkymusic.action.RECOGNITION"
    ...
    companion object {
        const val ACTION_START_RECOGNITION = "lumi.sparkynox.sparkymusic.widget.recognizer.TAP_MIC"
        const val ACTION_UPDATE_WIDGET = "lumi.sparkynox.sparkymusic.widget.recognizer.UPDATE"
        const val ACTION_RESET_STATE = "lumi.sparkynox.sparkymusic.widget.recognizer.RESET"
    }
}
