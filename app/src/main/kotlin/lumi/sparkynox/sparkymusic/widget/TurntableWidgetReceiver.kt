...
class TurntableWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_TURNTABLE_PLAY_PAUSE = "lumi.sparkynox.sparkymusic.widget.TURNTABLE_PLAY_PAUSE"
        const val ACTION_TURNTABLE_NEXT = "lumi.sparkynox.sparkymusic.widget.TURNTABLE_NEXT"
        const val ACTION_TURNTABLE_PREVIOUS = "lumi.sparkynox.sparkymusic.widget.TURNTABLE_PREVIOUS"
        const val ACTION_UPDATE_TURNTABLE_WIDGET = "lumi.sparkynox.sparkymusic.widget.UPDATE_TURNTABLE_WIDGET"
    }
}
