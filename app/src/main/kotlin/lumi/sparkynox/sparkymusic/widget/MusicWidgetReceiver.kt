...
class MusicWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "lumi.sparkynox.sparkymusic.widget.PLAY_PAUSE"
        const val ACTION_LIKE = "lumi.sparkynox.sparkymusic.widget.LIKE"
        const val ACTION_NEXT = "lumi.sparkynox.sparkymusic.widget.NEXT"
        const val ACTION_PREVIOUS = "lumi.sparkynox.sparkymusic.widget.PREVIOUS"
        const val ACTION_UPDATE_WIDGET = "lumi.sparkynox.sparkymusic.widget.UPDATE_WIDGET"
    }
}
