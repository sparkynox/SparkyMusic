...
class PlaylistWidgetReceiver : AppWidgetProvider() {
    ...
    private fun openTargetInApp(context: Context, source: Intent) {
        val activityIntent = Intent(context, MainActivity::class.java).apply {
            action = "lumi.sparkynox.sparkymusic.action.OPEN_WIDGET_TARGET"
    ...
    companion object {
        ...
        const val ACTION_PLAY_TARGET = "lumi.sparkynox.sparkymusic.widget.playlists.PLAY_TARGET"
        const val ACTION_UPDATE_WIDGET = "lumi.sparkynox.sparkymusic.widget.playlists.UPDATE_WIDGET"
