...
import lumi.sparkynox.sparkymusic.utils.PlaybackLogLevel
...
import lumi.sparkynox.sparkymusic.utils.cipher.CipherDeobfuscator
import lumi.sparkynox.sparkymusic.utils.YTPlayerUtils.MAIN_CLIENT
import lumi.sparkynox.sparkymusic.utils.YTPlayerUtils.STREAM_FALLBACK_CLIENTS
import lumi.sparkynox.sparkymusic.utils.YTPlayerUtils.validateStatus
import lumi.sparkynox.sparkymusic.utils.potoken.PoTokenGenerator
import lumi.sparkynox.sparkymusic.utils.potoken.PoTokenResult
import lumi.sparkynox.sparkymusic.utils.sabr.EjsNTransformSolver
...
object YTPlayerUtils {
     ...
     */
    @Volatile
    var playbackEngine: lumi.sparkynox.sparkymusic.constants.PlaybackEngine = lumi.sparkynox.sparkymusic.constants.PlaybackEngine.AUTO
    ...
    private suspend fun findUrlOrNull(
        ...
        val useCipher = engine == lumi.sparkynox.sparkymusic.constants.PlaybackEngine.POTOKEN || engine == lumi.sparkynox.sparkymusic.constants.PlaybackEngine.AUTO
        if (useCipher) {
        ...
        val useBravePipe = engine == lumi.sparkynox.sparkymusic.constants.PlaybackEngine.BRAVEPIPE || engine == lumi.sparkynox.sparkymusic.constants.PlaybackEngine.AUTO
        if (useBravePipe) {
            if (skipNewPipe) {
