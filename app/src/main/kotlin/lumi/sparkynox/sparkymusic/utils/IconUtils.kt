...
object IconUtils {
    fun setIcon(context: Context, isDynamic: Boolean, isLegacy: Boolean) {
        ...
        val dynamic = ComponentName(context, "lumi.sparkynox.sparkymusic.MainActivityAlias")
        val static = ComponentName(context, "lumi.sparkynox.sparkymusic.MainActivityStatic")
        val legacy = ComponentName(context, "lumi.sparkynox.sparkymusic.MainActivityLegacy")
