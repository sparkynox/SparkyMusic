                ...
                items = buildList {
                    add(
                        Material3MenuItemData(
                            customComposable = {
                                lumi.sparkynox.sparkymusic.ui.component.CastButton(asMenuItem = true)
                            }
                        )
                    )
                    ...
                    add(
                        Material3MenuItemData(
                            ...
                            onClick = {
                                ...
                                androidx.media3.exoplayer.offline.DownloadService.sendRemoveDownload(context, lumi.sparkynox.sparkymusic.playback.ExoDownloadService::class.java, mediaMetadata.id, false)
