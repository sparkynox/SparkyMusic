...
import lumi.sparkynox.sparkymusic.constants.MediaSessionConstants
...
constructor(
                            ...
                            parentId.startsWith("${MusicService.YOUTUBE_PLAYLIST}/") -> {
                                ...
                                try {
                                    val songs = YouTube.playlist(playlistId).getOrNull()?.songs
                                        ...
                                        ?.filterVideoSongs(context.dataStore.get(HideVideoSongsKey, false) || context.dataStore.get(lumi.sparkynox.sparkymusic.constants.DataSaverEnabledKey, false))
                                        ?: emptyList()
    ...
    private fun lumi.sparkynox.sparkymusic.db.entities.Playlist.toBrowsableMediaItem() = browsableMediaItem(
