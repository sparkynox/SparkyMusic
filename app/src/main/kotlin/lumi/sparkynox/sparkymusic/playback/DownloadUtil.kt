...
import lumi.sparkynox.sparkymusic.utils.enumPreference
...
constructor(
    ...
    private val downloadQuality by enumPreference(context, lumi.sparkynox.sparkymusic.constants.DownloadQualityKey, lumi.sparkynox.sparkymusic.constants.DownloadQuality.YOUTUBE)
        ...
        ResolvingDataSource.Factory(
            ...
            val playbackData = runBlocking(Dispatchers.IO) {
                YTPlayerUtils.playerResponseForPlayback(
                    videoId = mediaId,
                    audioQuality = lumi.sparkynox.sparkymusic.constants.AudioQuality.OPUS,
