...
package lumi.sparkynox.sparkymusic.echomusic.updater
...
import lumi.sparkynox.sparkymusic.echomusic.updater.downloadmanager.UpdateDownloadWorker
import lumi.sparkynox.sparkymusic.echomusic.updater.downloadmanager.DownloadNotificationManager
...
import lumi.sparkynox.sparkymusic.ui.component.ChangelogItem
import lumi.sparkynox.sparkymusic.ui.component.leadingItemShape
import lumi.sparkynox.sparkymusic.ui.component.middleItemShape
import lumi.sparkynox.sparkymusic.ui.component.endItemShape
import lumi.sparkynox.sparkymusic.ui.component.detachedItemShape
import lumi.sparkynox.sparkymusic.ui.component.parseMarkdown
import lumi.sparkynox.sparkymusic.ui.component.endItemShape
import lumi.sparkynox.sparkymusic.ui.component.detachedItemShape
import lumi.sparkynox.sparkymusic.ui.component.AnimatedActionButton
import lumi.sparkynox.sparkymusic.ui.component.ExpressiveIconButton
import lumi.sparkynox.sparkymusic.ui.component.ErrorSnackbar
                                ...
                                AnimatedActionButton(
                                    ...
                                    onClick = {
                                        if (isDownloadComplete) {
                                            ...
                                            val urlToDownload = currentStatus.apkUrl ?: "https://github.com/sparkynox/SparkyMusic/releases/download/${currentStatus.version}/sparkymusic.apk"
...
suspend fun checkForUpdate(
    ...
    withContext(Dispatchers.IO) {
        try {
            val url = URL("https://api.github.com/repos/sparkynox/SparkyMusic/releases/latest")
            ...
            if (shouldShow) {
                ...
                try {
                    val changelogUrl =
                        URL("https://github.com/sparkynox/SparkyMusic/releases/download/$tagWithPrefix/changelog.json")
