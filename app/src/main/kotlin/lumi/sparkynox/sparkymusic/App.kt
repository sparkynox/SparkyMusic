...
import lumi.sparkynox.sparkymusic.di.ApplicationScope
import lumi.sparkynox.sparkymusic.extensions.toEnum
import lumi.sparkynox.sparkymusic.extensions.toInetSocketAddress
import lumi.sparkynox.sparkymusic.utils.CrashHandler
import lumi.sparkynox.sparkymusic.utils.AppContextHolder
...
class App : Application(), SingletonImageLoader.Factory {
    ...
    override fun onCreate() {
        ...
        lumi.sparkynox.sparkymusic.utils.cipher.CipherDeobfuscator.initialize(this)
    ...
    private suspend fun initializeSettings() {
        ...
        val engineName = settings[lumi.sparkynox.sparkymusic.constants.PlaybackEngineKey]
        lumi.sparkynox.sparkymusic.utils.YTPlayerUtils.playbackEngine = try {
            if (engineName != null) lumi.sparkynox.sparkymusic.constants.PlaybackEngine.valueOf(engineName)
            else lumi.sparkynox.sparkymusic.constants.PlaybackEngine.AUTO
        } catch (_: Exception) { lumi.sparkynox.sparkymusic.constants.PlaybackEngine.AUTO }
    ...
    private fun observeSettingsChanges() {
        ...
        lumi.sparkynox.sparkymusic.utils.lastfm.LastFM.initialize(
