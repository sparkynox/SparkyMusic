...
package lumi.sparkynox.sparkymusic.listentogether
...
import lumi.sparkynox.sparkymusic.constants.ListenTogetherAutoApprovalKey
import lumi.sparkynox.sparkymusic.constants.ListenTogetherIsHostKey
import lumi.sparkynox.sparkymusic.constants.ListenTogetherRoomCodeKey
import lumi.sparkynox.sparkymusic.constants.ListenTogetherServerUrlKey
import lumi.sparkynox.sparkymusic.constants.ListenTogetherSessionTimestampKey
import lumi.sparkynox.sparkymusic.constants.ListenTogetherSessionTokenKey
import lumi.sparkynox.sparkymusic.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient @Inject constructor(
    ...
    companion object {
        ...
        const val ACTION_APPROVE_JOIN = "lumi.sparkynox.sparkymusic.LISTEN_TOGETHER_APPROVE_JOIN"
        const val ACTION_REJECT_JOIN = "lumi.sparkynox.sparkymusic.LISTEN_TOGETHER_REJECT_JOIN"
        const val ACTION_APPROVE_SUGGESTION = "lumi.sparkynox.sparkymusic.LISTEN_TOGETHER_APPROVE_SUGGESTION"
        const val ACTION_REJECT_SUGGESTION = "lumi.sparkynox.sparkymusic.LISTEN_TOGETHER_REJECT_SUGGESTION"
    ...
    private fun loadBlockedUsernames() {
        try {
            val blockedJson = context.dataStore.get(lumi.sparkynox.sparkymusic.constants.ListenTogetherBlockedUsersKey, "")
    ...
    private suspend fun saveBlockedUsernames() {
        try {
            ...
            context.dataStore.edit { preferences ->
                preferences[lumi.sparkynox.sparkymusic.constants.ListenTogetherBlockedUsersKey] = blockedJson
            }
        } catch (e: Exception) {
