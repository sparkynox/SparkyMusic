package lumi.sparkynox.sparkymusic.media3.di
...
import lumi.sparkynox.sparkymusic.common.Config.CANVAS_CACHE
...
import lumi.sparkynox.sparkymusic.common.Config.PLAYER_CACHE
...
import lumi.sparkynox.sparkymusic.media3.cast.CastHandoffManager
import lumi.sparkynox.sparkymusic.media3.cast.CastStreamResolver
import lumi.sparkynox.sparkymusic.media3.exoplayer.CrossfadeExoPlayerAdapter
import lumi.sparkynox.sparkymusic.media3.extension.isFullyCached
import lumi.sparkynox.sparkymusic.media3.repository.CacheRepositoryImpl
import lumi.sparkynox.sparkymusic.media3.service.SimpleMediaService
import lumi.sparkynox.sparkymusic.media3.service.callback.SimpleMediaSessionCallback
import lumi.sparkynox.sparkymusic.media3.service.download.DownloadUtils
import lumi.sparkynox.sparkymusic.media3.service.mediasourcefactory.MergingMediaSourceFactory
import lumi.sparkynox.sparkymusic.media3.utils.CoilBitmapLoader
...
import lumi.sparkynox.sparkymusic.cast.initCast
import lumi.sparkynox.sparkymusic.cast.wrapWithCastPlayer
...
private val mediaServiceModule =
    module {
        ...
        // Cast support in the full build; lumi.sparkynox.sparkymusic.cast no-ops back to the same instance
