package lumi.sparkynox.sparkymusic.media3.service
...
import lumi.sparkynox.sparkymusic.common.MEDIA_NOTIFICATION
...
import lumi.sparkynox.sparkymusic.media3.R
import lumi.sparkynox.sparkymusic.media3.extension.toCommandButton
...
internal class SimpleMediaService :
    MediaLibraryService(),
    KoinComponent {
    private val coroutineScope by inject<CoroutineScope>(named(lumi.sparkynox.sparkymusic.common.Config.SERVICE_SCOPE))
    ...
    private val player: Player by inject<Player>(qualifier = named(lumi.sparkynox.sparkymusic.common.Config.MAIN_PLAYER))
