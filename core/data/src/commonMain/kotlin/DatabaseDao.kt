...
import lumi.sparkynox.sparkymusic.domain.data.entities.AutoEqCurveEntity
import lumi.sparkynox.sparkymusic.domain.data.entities.AutoEqEntryEntity
import lumi.sparkynox.sparkymusic.domain.data.entities.AutoEqIndexMetaEntity
...
import lumi.sparkynox.sparkymusic.domain.data.entities.QueueEntity
import lumi.sparkynox.sparkymusic.domain.data.entities.SearchHistory
...
import lumi.sparkynox.sparkymusic.domain.data.entities.analytics.EventArtistEntity
import lumi.sparkynox.sparkymusic.domain.data.entities.analytics.PlaybackEventEntity
import lumi.sparkynox.sparkymusic.domain.data.entities.analytics.query.TopPlayedAlbum
import lumi.sparkynox.sparkymusic.domain.data.entities.analytics.query.TopPlayedArtist
import lumi.sparkynox.sparkymusic.domain.data.entities.analytics.query.TopPlayedTracks
 ...
 *
 * Kept in step with the copy in [lumi.sparkynox.sparkymusic.data.db.datasource.LocalDataSource] and with the
...
interface DatabaseDao {
     ...
     * [lumi.sparkynox.sparkymusic.data.db.datasource.LocalDataSource.insertSong], which is right when a track
