package lumi.sparkynox.sparkymusic.data.mapping

import lumi.sparkynox.sparkymusic.data.parser.toListThumbnail
...
import lumi.sparkynox.sparkymusic.domain.data.model.searchResult.artists.ArtistsResult
...
import lumi.sparkynox.sparkymusic.domain.data.model.searchResult.videos.VideosResult
...
import lumi.sparkynox.sparkymusic.spotify.model.response.spotify.CanvasResponse
import lumi.sparkynox.sparkymusic.spotify.model.response.spotify.SpotifyLyricsResponse
import lumi.sparkynox.sparkymusic.lyrics.models.response.LyricsResponse
import lumi.sparkynox.sparkymusic.lyrics.models.response.TranslatedLyricsResponse
import lumi.sparkynox.sparkymusic.lyrics.parser.parseRichSyncLyrics
import lumi.sparkynox.sparkymusic.lyrics.parser.parseSyncedLyrics
import lumi.sparkynox.sparkymusic.lyrics.parser.parseUnsyncedLyrics
...
internal fun Track.toSongItemForDownload(): SongItem =
    SongItem(
        ...
        artists =
            this.artists?.map {
                lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.Artist(
                    id = it.id ?: "",
                    name = it.name,
                )
            } ?: emptyList(),
        album =
            lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.Album(
                id = this.album?.id ?: "",
...
internal fun lumi.sparkynox.sparkymusic.lyrics.domain.Lyrics.toLyrics(): Lyrics {
...
internal fun Lyrics.toLibraryLyrics(): lumi.sparkynox.sparkymusic.lyrics.domain.Lyrics =
    lumi.sparkynox.sparkymusic.lyrics.domain.Lyrics(
        lyrics =
            lumi.sparkynox.sparkymusic.lyrics.domain.Lyrics.LyricsX(
                lines =
                    this.lines?.map {
                        lumi.sparkynox.sparkymusic.lyrics.domain.Lyrics.LyricsX.Line(
                            endTimeMs = it.endTimeMs,
                            startTimeMs = it.startTimeMs,
                            syllables = listOf(),
                            words = it.words,
...
internal fun SearchSuggestions.toDomainSearchSuggestions(): lumi.sparkynox.sparkymusic.domain.data.model.searchResult.SearchSuggestions =
    lumi.sparkynox.sparkymusic.domain.data.model.searchResult.SearchSuggestions(
...
internal fun AccountInfo.toDomainAccountInfo(): lumi.sparkynox.sparkymusic.domain.data.model.account.AccountInfo =
    lumi.sparkynox.sparkymusic.domain.data.model.account.AccountInfo(
        name = this.name,
        email = this.email,
        pageId = this.pageId,
