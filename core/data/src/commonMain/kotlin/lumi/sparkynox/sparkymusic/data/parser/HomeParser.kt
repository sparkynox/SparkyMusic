...
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.SectionListRenderer
...
fun Thumbnail.toThumbnail(): lumi.sparkynox.sparkymusic.domain.data.model.searchResult.songs.Thumbnail =
    lumi.sparkynox.sparkymusic.domain.data.model.searchResult.songs.Thumbnail(
        height = this.height ?: 0,
        url = this.url,
        width = this.width ?: 0,
    )

fun List<Thumbnail>.toListThumbnail(): List<lumi.sparkynox.sparkymusic.domain.data.model.searchResult.songs.Thumbnail> {
    val list = mutableListOf<lumi.sparkynox.sparkymusic.domain.data.model.searchResult.songs.Thumbnail>()
    this.forEach {
