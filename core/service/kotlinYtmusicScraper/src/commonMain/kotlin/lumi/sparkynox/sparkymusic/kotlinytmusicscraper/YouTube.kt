package lumi.sparkynox.sparkymusic.kotlinytmusicscraper

import com.eygraber.uri.toKmpUri
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.YouTube.Companion.DEFAULT_VISITOR_DATA
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.extension.toListFormat
...
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.ArtistItem
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.BrowseEndpoint
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.GridRenderer
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.MediaType
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.MusicCarouselShelfRenderer
...
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.ReturnYouTubeDislikeResponse
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.Run
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.SearchSuggestions
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.SongInfo
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.SongItem
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.TidalMetadataResult
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.VideoItem
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.WatchEndpoint
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.YTItemType
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.YouTubeClient
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.YouTubeClient.Companion.TVHTML5
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.YouTubeClient.Companion.WEB
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.YouTubeClient.Companion.WEB_REMIX
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.YouTubeLocale
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.getContinuation
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.oddElements
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.response.AccountMenuResponse
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.response.AccountSwitcherEndpointResponse
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.response.AddItemYouTubePlaylistResponse
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.response.BrowseResponse
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.response.CreatePlaylistResponse
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.response.DownloadProgress
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.response.GetQueueResponse
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.response.GetSearchSuggestionsResponse
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.response.LikeStatus
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.response.NextAndroidMusicResponse
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.response.NextResponse
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.response.PipedResponse
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.response.PlayerResponse
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.response.SearchResponse
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.response.SimpMusicChartResponse
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.response.TidalSearchResponse
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.response.TidalOAuthResponse
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.response.RemoteConfig
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.response.toLikeStatus
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.response.toListAccountInfo
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.simpmusic.FdroidResponse
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.simpmusic.GithubResponse
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.sponsorblock.SkipSegments
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.youtube.GhostResponse
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.youtube.Transcript
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.youtube.YouTubeInitialPage
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.models.youtube.tryDecodeText
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.pages.AlbumPage
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.pages.ArtistPage
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.pages.ArtistSection
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.pages.BrowseResult
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.pages.ExplorePage
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.pages.MoodAndGenres
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.pages.NextPage
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.pages.NextResult
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.pages.PlaylistContinuationPage
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.pages.PlaylistPage
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.pages.RelatedPage
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.pages.SearchPage
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.pages.SearchResult
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.pages.SearchSuggestionPage
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.parser.fromPlaylistContinuationToTracks
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.parser.fromPlaylistToTrack
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.parser.fromPlaylistToTrackWithSetVideoId
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.parser.getContinuePlaylistContinuation
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.parser.getPlaylistContinuation
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.parser.getReloadParams
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.parser.getSuggestionSongItems
import lumi.sparkynox.sparkymusic.kotlinytmusicscraper.parser.hasReloadParams
