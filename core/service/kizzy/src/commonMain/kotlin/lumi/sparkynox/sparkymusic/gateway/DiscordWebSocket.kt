package lumi.sparkynox.sparkymusic.gateway

import lumi.sparkynox.sparkymusic.logger.Logger
import lumi.sparkynox.sparkymusic.gateway.entities.Heartbeat
import lumi.sparkynox.sparkymusic.gateway.entities.Identify.Companion.toIdentifyPayload
import lumi.sparkynox.sparkymusic.gateway.entities.Payload
import lumi.sparkynox.sparkymusic.gateway.entities.Ready
import lumi.sparkynox.sparkymusic.gateway.entities.Resume
import lumi.sparkynox.sparkymusic.gateway.entities.op.OpCode
import lumi.sparkynox.sparkymusic.gateway.entities.op.OpCode.DISPATCH
import lumi.sparkynox.sparkymusic.gateway.entities.op.OpCode.HEARTBEAT
import lumi.sparkynox.sparkymusic.gateway.entities.op.OpCode.HELLO
import lumi.sparkynox.sparkymusic.gateway.entities.op.OpCode.IDENTIFY
import lumi.sparkynox.sparkymusic.gateway.entities.op.OpCode.INVALID_SESSION
import lumi.sparkynox.sparkymusic.gateway.entities.op.OpCode.PRESENCE_UPDATE
import lumi.sparkynox.sparkymusic.gateway.entities.op.OpCode.RECONNECT
import lumi.sparkynox.sparkymusic.gateway.entities.op.OpCode.RESUME
import lumi.sparkynox.sparkymusic.gateway.entities.presence.Presence
