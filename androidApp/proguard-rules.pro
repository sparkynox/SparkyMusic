...
-keep class lumi.sparkynox.sparkymusic.data.model.** { *; }
-keep class lumi.sparkynox.sparkymusic.extension.AllExtKt { *; }
-keep class lumi.sparkynox.sparkymusic.extension.AllExtKt$* { *; }
-keep class lumi.sparkynox.sparkymusic.kotlinytmusicscraper.extension.MapExtKt$* { *; }
...
-dontwarn lumi.sparkynox.sparkymusic.data.di.loader.LoaderKt
-dontwarn lumi.sparkynox.sparkymusic.media3.ui.MediaPlayerViewKt
...
-keep class lumi.sparkynox.sparkymusic.data.di.** { *; }
