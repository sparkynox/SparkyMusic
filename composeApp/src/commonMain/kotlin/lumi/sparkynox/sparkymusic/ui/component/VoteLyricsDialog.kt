...
import lumi.sparkynox.sparkymusic.ui.icon.ThumbDown
import lumi.sparkynox.sparkymusic.ui.icon.ThumbUp
import lumi.sparkynox.sparkymusic.ui.theme.typo
import lumi.sparkynox.sparkymusic.viewModel.VoteData
import lumi.sparkynox.sparkymusic.viewModel.VoteState
import org.jetbrains.compose.resources.stringResource
import sparkymusic.composeapp.generated.resources.Res
import sparkymusic.composeapp.generated.resources.cancel
import sparkymusic.composeapp.generated.resources.downvote
import sparkymusic.composeapp.generated.resources.rate_lyrics
import sparkymusic.composeapp.generated.resources.rate_translated_lyrics
import sparkymusic.composeapp.generated.resources.upvote
import sparkymusic.composeapp.generated.resources.vote_for_lyrics
        ...
        Column(
            ...
            when (voteState.state) {
                ...
                is VoteState.Success -> {
                    Icon(
                        imageVector = if (voteState.state.upvote) echoIcons.ThumbUp else echoIcons.ThumbDown,
                ...
                is VoteState.Idle -> {
                    Row(
                        ...
                        IconButton(
                            ...
                            Icon(
                                imageVector = echoIcons.ThumbDown,
