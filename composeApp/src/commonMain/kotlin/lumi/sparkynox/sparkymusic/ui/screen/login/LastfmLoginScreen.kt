...
import lumi.sparkynox.sparkymusic.viewModel.LastfmLoginState
...
import sparkymusic.composeapp.generated.resources.lastfm_login_step_1
import sparkymusic.composeapp.generated.resources.lastfm_login_step_2
import sparkymusic.composeapp.generated.resources.lastfm_open_authorize_page
import sparkymusic.composeapp.generated.resources.lastfm_paste_callback_confirm
import sparkymusic.composeapp.generated.resources.lastfm_paste_callback_hint
import sparkymusic.composeapp.generated.resources.lastfm_paste_callback_title
...
/**
 * Last.fm's desktop auth flow, which is what echoMusic uses on every platform.
 *
 * There is no WebView here on purpose — unlike the Discord and Spotify screens, this never sees the
 * user's password. echoMusic asks Last.fm for a request token, sends the user to Last.fm's own page
